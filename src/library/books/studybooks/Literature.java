...
public class Literature extends StudyBook {
    public Literature(int bookId, String bookName, String author, double price, boolean status, String edition, String category, Lesson lesson) {
