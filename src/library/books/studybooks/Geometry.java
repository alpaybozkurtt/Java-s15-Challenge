...
public class Geometry extends StudyBook {
    public Geometry(int bookId, String bookName, String author, double price, boolean status, String edition, String category, Lesson lesson) {
