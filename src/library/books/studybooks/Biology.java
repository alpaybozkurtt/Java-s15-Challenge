...
public class Biology extends StudyBook {
    public Biology(int bookId, String bookName, String author, double price, boolean status, String edition, String category, Lesson lesson) {
